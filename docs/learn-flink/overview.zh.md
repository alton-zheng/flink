...
- [本章教程的目标及涵盖范围](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/#本章教程的目标及涵盖范围)
- 流处理
  - [并行 Dataflows](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/#并行-dataflows)
- [自定义时间流处理](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/#自定义时间流处理)
- [有状态流处理](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/#有状态流处理)
- [通过状态快照实现的容错](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/#通过状态快照实现的容错)
...
**Note** 每小节教程都有实践练习引导你如何在程序中使用其所述的概念，并在小节结尾都提供了相关实践练习的代码链接。

[ Back to top](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/#top)
