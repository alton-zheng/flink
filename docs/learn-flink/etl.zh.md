...
这里注意，Flink 的 [Table 和 SQL API](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/) 完全可以满足很多 ETL 使用场景。但无论你最终是否直接使用 DataStream API，对这里介绍的基本知识有扎实的理解都是有价值的。

- 无状态的转换
  - [`map()`](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#map)
  - [`flatmap()`](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#flatmap)
- Keyed Streams
  - [`keyBy()`](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#keyby)
  - [通过计算得到键](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#通过计算得到键)
  - [Keyed Stream 的聚合](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#keyed-stream-的聚合)
  - [（隐式的）状态](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#隐式的状态)
  - [`reduce()` 和其他聚合算子](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#reduce-和其他聚合算子)
- 有状态的转换
  - [Flink 为什么要参与状态管理？](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#flink-为什么要参与状态管理)
  - [Rich Functions](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#rich-functions)
  - [一个使用 Keyed State 的例子](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#一个使用-keyed-state-的例子)
  - [清理状态](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#清理状态)
  - [Non-keyed State](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#non-keyed-state)
- Connected Streams
  - [示例](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#示例)
- [动手练习](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#动手练习)
- [延展阅读](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#延展阅读)

## 无状态的转换

本节涵盖了 `map()` 和 `flatmap()`，这两种算子可以用来实现无状态转换的基本操作。本节中的示例建立在你已经熟悉 [flink-training repo](https://github.com/apache/flink-training/tree/release-1.12) 中的出租车行程数据的基础上。
...
[ Back to top](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#top)
...
![keyBy and network shuffle](https://ci.apache.org/projects/flink/flink-docs-release-1.12/fig/keyBy.png)
...
在没有键的上下文中我们也可以使用 Flink 管理的状态。这也被称作 [算子的状态](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/stream/state/state.html#operator-state)。它包含的接口是很不一样的，由于对用户定义的函数来说使用 non-keyed state 是不太常见的，所以这里就不多介绍了。这个特性最常用于 source 和 sink 的实现。
...
![simple transformation](https://ci.apache.org/projects/flink/flink-docs-release-1.12/fig/transformation.svg)

有时你想要更灵活地调整转换的某些功能，比如数据流的阈值、规则或者其他参数。Flink 支持这种需求的模式称为 *connected streams* ，一个单独的算子有两个输入流。

![connected streams](https://ci.apache.org/projects/flink/flink-docs-release-1.12/fig/connected-streams.svg)
...
认识到你没法控制 `flatMap1` 和 `flatMap2` 的调用顺序是很重要的。这两个输入流是相互竞争的关系，Flink 运行时将根据从一个流或另一个流中消费的事件做它要做的。对于需要保证时间和/或顺序的场景，你会发现在 Flink 的管理状态中缓存事件一直到它们能够被处理是必须的。（注意：如果你真的感到绝望，可以使用自定义的算子实现 [InputSelectable](https://ci.apache.org/projects/flink/flink-docs-release-1.12/api/java/org/apache/flink/streaming/api/operators/InputSelectable.html) 接口，在两输入算子消费它的输入流时增加一些顺序上的限制。）

[ Back to top](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#top)

## 动手练习

本节的动手练习是 [行程和票价练习](https://github.com/apache/flink-training/tree/release-1.12/rides-and-fares)。

[ Back to top](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/learn-flink/etl.html#top)

## 延展阅读

- [数据流转换](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/stream/operators/#datastream-transformations)
- [有状态流的处理](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/concepts/stateful-stream-processing.html)
