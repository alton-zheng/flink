...
- [概述](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#概述)
- 开发指南
  - [函数类](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#函数类)
  - [求值方法](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#求值方法)
  - [类型推导](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#类型推导)
  - [运行时集成](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#运行时集成)
- [标量函数](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#标量函数)
- [表值函数](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#表值函数)
- [聚合函数](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#聚合函数)
- [表值聚合函数](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#表值聚合函数)
...
**注意** 标量和表值函数已经使用了新的基于[数据类型](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/types.html)的类型系统，聚合函数仍然使用基于 `TypeInformation` 的旧类型系统。

以下示例展示了如何创建一个基本的标量函数，以及如何在 Table API 和 SQL 里调用这个函数。

函数用于 SQL 查询前要先经过注册；而在用于 Table API 时，函数可以先注册后调用，也可以 *内联* 后直接使用。

- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_0)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_0)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_1)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_1)
...
[ Back to top](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#top)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_2)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_2)
...
Table（类似于 SQL 标准）是一种强类型的 API。因此，函数的参数和返回类型都必须映射到[数据类型](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/types.html)。
...
有关可以隐式映射到数据类型的类的完整列表，请参阅[数据类型](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/types.html#数据类型注解)。
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_3)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_3)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_4)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_4)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_5)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_6)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_6)
...
自定义标量函数可以把 0 到多个标量值映射成 1 个标量值，[数据类型](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/types.html)里列出的任何数据类型都可作为求值方法的参数和返回值类型。
...
下面的例子展示了如何实现一个求哈希值的函数并在查询里调用它，详情可参考[开发指南](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#开发指南)：

- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_7)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_7)
...
如果你打算使用 Python 实现或调用标量函数，详情可参考 [Python 标量函数](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/python/table-api-users-guide/udfs/python_udfs.html#scalar-functions)。
...
下面的例子展示了如何实现一个分隔函数并在查询里调用它，详情可参考[开发指南](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#开发指南)：

- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_8)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_8)
...
如果你打算使用 Python 实现或调用表值函数，详情可参考 [Python 表值函数](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/python/table-api-users-guide/udfs/python_udfs.html#table-functions)。
...
![UDAGG mechanism](https://ci.apache.org/projects/flink/flink-docs-release-1.12/fig/udagg-mechanism.png)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_9)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_9)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_10)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_10)
- [**Python**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Python_10)
...
如果你打算使用 Python 实现或调用聚合函数，详情可参考 [Python 聚合函数](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/python/table-api-users-guide/udfs/python_udfs.html#aggregate-functions)。
...
![UDAGG mechanism](https://ci.apache.org/projects/flink/flink-docs-release-1.12/fig/udtagg-mechanism.png)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_11)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_11)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_12)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_12)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Java_13)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.12/zh/dev/table/functions/udfs.html#tab_Scala_13)
